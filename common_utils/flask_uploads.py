...
DOCUMENTS = tuple('txt pdf doc docx xls xlsx'.split())
...
class UploadSet(object):
    ...
    def extension_allowed(self, ext):
        ...
        """
        # print('...............extension_allowed........ext:', ext)
        # print('...............extension_allowed........self.config.allow:', self.config.allow)
        # print('...............extension_allowed........self.extensions:', self.extensions)
        # print('...............extension_allowed........self.config.deny:', self.config.deny)
        # print('...............extension_allowed........in:', (ext in self.extensions))
        # print('...............extension_allowed........in:', (ext in self.extensions and ext not in self.config.deny))
    ...
    def save(self, storage, folder=None, name=None):
        ...
        if basename in self.extensions:
            basename = 'abc.' + basename
        # print('...............filename:', storage.filename)
